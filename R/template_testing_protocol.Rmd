...
_This template will automatic update all the values according to the new data file and the choice of the pot. Only the red text should be changed manually!_

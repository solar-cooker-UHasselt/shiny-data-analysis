...
This Standard specifies that test results should be presented as cooking power, in Watts, normalized for ambient conditions, relative to the temperature difference between cooker contents and ambient air, both as a plot and as a regression equation for no fewer than 30 total observations over three different days.
...
_Maximum Wind._ Should the wind exceed 2.5 m/s for more than ten minutes the test data shall be discarded. If a wind shelter is required, it shall be designed so as to not interfere with incoming total radiation and the wind instrumentation shall be co-located with the cooker in the same wind shadow.

_Ambient temperature._ Tests should be conducted when ambient temperatures are between 20 and 35 °C. Test data shall be recorded while cooking vessel contents (water) are at temperatures between 5 °C above ambient and 5 °C below local boiling temperature.

  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(
        ...
        mainPanel(
          strong(
            "This page is build to upload the data of the three testing days. After having uploaded the data, for each day graphs will be made to do data exploration.
          ...
          tags$hr(),
          p(
            "The download button bellow can be used to download the data compressed to 10min time intervals. This dataset contains as output average measurements of, e.g., the
          ...
          fluidRow(
            box(
              ...
              fileInput(
                "file1",
                "Choose your teststation data file (.CSV)",
                accept = c("text/csv", "text/comma-separated-values,text/plain", ".csv")
              ),
              fileInput(
                "file1meta",
                "Choose the corresponding metadata file (.CSV)",
                accept = c("text/csv", "text/comma-separated-values,text/plain", ".csv")
              ),
          ...
          fluidRow(
            box(
              width = 12,
              collapsed = TRUE,
              title = "Additional information on the teststation data file",
              status = "danger",
              solidHeader = TRUE,
              p(
                "The teststation data file should include the following information in the order below:"
              ),
              column(12, tags$div(
                id = "info_list",
                tags$ul(
            ...
            box(
              width = 12,
              collapsed = TRUE,
              title = "Additional information on the metadata file",
              status = "danger",
              solidHeader = TRUE,
              p(
                "The metadata file should include the following information in the order below:"
              ),
              column(12, tags$div(
                id = "info_list",
                tags$ul(
              ...
              p(
                "Download the template below as example. Change XXXXXX in PEPUNILU2024XXXXXX to the correct number of your datafile."
              ),
      ...
      # Second Tabpanel
      #---------------------------------------------------------------------------
      tabItem(tabName = "graph", tabsetPanel(
        tabPanel(
          "Graphs day 1",
          mainPanel(
            plotOutput("Plot11"),
      ...
      tabItem(
        ...
        mainPanel(
          ...
          strong(
            "A small report will be generated after you uploaded the data for the 3 days."
          ),
          tags$hr(),
      ...
      tabItem(tabName = "protocol", uiOutput("htmloutput")),
      ...
      tabItem(
        ...
        strong(
          "Jonas Meijerink (",
          a("jonas.meijerink@student.uhasselt.be", href = "mailto:jonas.meijerink@student.uhasselt.be"),
          ")"
        ),
        h3("Collaborators"),
